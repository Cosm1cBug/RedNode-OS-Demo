...
pub async fn export_legacy() -> LegacyPackage {
    ...
    let pkg = LegacyPackage { id: gen_id(), version: "0.37.0".into(), created_at: Utc::now(), identity, constitution, goals, capabilities, episodic_highlights: episodes, procedures, personality, trust_scores: trust, ethical_values: ethics, cognitive_metrics: metrics, checksum };
